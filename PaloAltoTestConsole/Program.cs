                ...
                switch (input)
                {
                    ...
                    case "Management":
                        ...
                        if (mgmtType == "Add")
                        {
                            ...
                            Console.WriteLine("Forward Trust? Enter true or false");
                            var forwardTrust = Console.ReadLine();
                            ...
                            var jobConfiguration = GetJobConfiguration(privateKeyPwd, overWrite, forwardTrust, trustedRoot,
                                alias);
